...
export default {
  ...
  info: {
    ...
    description:
      'Essa é a documentação da API feita pelo aluno Wellington Perez no curso da Udemy de NodeJs usando Typescript, TDD, Clean Architecture e seguindo os princípios do SOLID e Design Patterns.',
    version: '1.0.0',
    contact: {
